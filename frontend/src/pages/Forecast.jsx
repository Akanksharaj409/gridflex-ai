...
export default function Forecast() {
  ...
  if (loading && !data) return <Loading what="forecast" />;
  if (!data) return null;
    ...
    <>
      <div className="page-head">
        ...
        <p>
          ...
          model attenuated by forecast cloud cover, with a bias correction fitted to the same history.
        </p>
      </div>
      ...
      <div className="grid g4">
        ...
        <Metric
          ...
          unit="kW"
          foot={bestSurplus ? `peaks at ${bestSurplus.label} · ${surplus.length}h of surplus` : 'no surplus in this horizon'}
          tone="var(--ok)"
        />
        <Metric
      ...
      <Card sub="Shaded band around demand is the forecast uncertainty, widening with lead time">
      ...
      <div className="section-title">Forecast detail</div>
      <div className="grid g-2-1">
              ...
              <tbody>
                {data.rows.map((r) => (
                  <tr key={r.step}>
                    ...
                    <td className="num" style={{ color: r.netKw >= 0 ? 'var(--ok)' : 'var(--danger)' }}>
        ...
        <div className="grid" style={{ alignContent: 'start' }}>
          <Card title="Model skill" sub="Backtested on the most recent day of history, held out of training">
          ...
          {shortage && (
            <Card title="Predicted shortage windows" sub="Hours where forecast grid import exceeds the import cap">
